...
function(enable_specific_sanitizers
  target_name
  ...
  message(TRACE "[${target_name}] - function 'enable_specific_sanitizers'")
...
# shortcut to enable all sanitizers configured via corresponding cache variables
function(enable_configured_sanitizers
  target_name)
  message(TRACE "[${target_name}] - function 'enable_configured_sanitizers'")

  enable_specific_sanitizers("${target_name}"
    "${ENABLE_SANITIZER_ADDRESS}"
    "${ENABLE_SANITIZER_LEAK}"
    "${ENABLE_SANITIZER_UNDEFINED_BEHAVIOR}"
    "${ENABLE_SANITIZER_THREAD}"
