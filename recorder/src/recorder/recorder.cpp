...
// 	std::string create_command = "create table tbl1(one text, two int);insert into tbl1 values('hello!',10);insert into
// tbl1 values('goodbye', 20);"; 	std::string read_command = "select * from tbl1;";
